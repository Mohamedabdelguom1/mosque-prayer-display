...
> فأضف وحدة RTC.
>
> الشاشة تحرس نفسها من هذا: عند كل تحديث ناجح تقارن ساعتها بترويسة `Date`
> التي يرسلها خادم Aladhan، وإن تجاوز الفارق خمس دقائق عرضت تنبيهاً أحمر
> صريحاً بدل أن تعرض مواقيت خاطئة بثقة.
