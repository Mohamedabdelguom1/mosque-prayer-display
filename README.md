...
**تعمل على أي تلفاز ذكي بنظام أندرويد، أو أي بوكس أو عصا أندرويد**
...
- **٣٫٣ ميغابايت** ذاكرة مقيسة على جهاز بـ٢ جيجا رام
...
## التركيب على أي جهاز أندرويد للتلفاز

الشاشة صفحة ويب، فهي تعمل على **أي جهاز بنظام أندرويد يتصل بالتلفاز**:

| الجهاز | ما تحتاجه |
|---|---|
| **تلفاز ذكي بنظام Android TV أو Google TV** | لا شيء — ثبّت المتصفح على التلفاز نفسه |
| **بوكس أندرويد** (أي ماركة) | وصّله بمدخل HDMI |
| **عصا أندرويد** — شاومي، أمازون فاير، أو غيرها | وصّلها بمدخل HDMI |

> **وإن كان تلفازك ليس أندرويد** — كأن يكون سامسونج بنظام Tizen أو
> إل جي بنظام webOS أو تلفازاً عادياً بلا نظام ذكي — فيكفي أن تشتري
> بوكس أو عصا أندرويد رخيصة وتوصّلها بمدخل HDMI. هذا أرخص وأضمن من
> محاولة تشغيلها على متصفح التلفاز نفسه.

**عن العتاد:** جُرّبت وقيست على عصا شاومي 4K — 2 جيجا رام، معالج
Cortex-A55، أندرويد TV 11. والواجهة مصمَّمة لهذا الحجم من العتاد أو
أقل: كل الحركات CSS على `transform` و`opacity` فقط، والذاكرة المقيسة
حول 3.3 ميغابايت. فما كان أقوى من ذلك يعمل عليها من باب أولى.
...
اترك الصفحة تُحمَّل كاملة مرة واحدة والجهاز متصل بالإنترنت. عندها:

- يخزّن عامل الخدمة كل ملفات الواجهة (٢٠ ملفاً، ٤ ميغابايت) داخل الجهاز.
...
> **ملاحظة:** الإعدادات تُحفظ داخل الجهاز نفسه لا على الخادم، فاضبطها
> عليه مباشرة. ولنسخها لمسجد آخر استخدم **تصدير JSON** من اللوحة.

### تحديث الشاشة لاحقاً

ادفع أي تعديل إلى فرع `main` على GitHub؛ يفحصه سير العمل (أنواع + تدقيق
+ ١١٨ اختباراً) وينشره تلقائياً. والجهاز يلتقط النسخة الجديدة عند أول إقلاع
متصل بالإنترنت.

## التركيب على جهاز لينكس (بديل)

إن استخدمت Raspberry Pi بدل جهاز الأندرويد، في `scripts/` خدمتا systemd جاهزتان:
