...
كل الصور في `public/bg` من ويكيميديا كومنز بتراخيص حرة تسمح بالاستخدام والتعديل.
رخص CC BY و CC BY-SA تشترط ذكر المصدر، وهذا الملف يفي بذلك.
إن استبدلتها بصورك الخاصة فاحذف هذا الملف أو حدّثه.

| الملف | العمل | المصوّر | الرخصة |
|---|---|---|---|
...
ضع صورك في `public/bg` ثم افتح لوحة الإعدادات (Ctrl + Shift + S) وحرّر حقل
«الخلفيات المتناوبة» — مسار في كل سطر هكذا `./bg/name.webp`.

يُفضّل صور عرضية 1920×1080 يقع فيها المبنى في الثلث الأيمن،
لأن الجهة اليسرى تُظلَّل لتستقبل البطاقات والنصوص.
